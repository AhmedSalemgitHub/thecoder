...
import 'package:thecoder/playing_card.dart';
  ...
  Image _suitToImage(int index, List<PlayingCard> myList) {
    switch (myList[index].cardSuit) {
      case CardSuit.hearts:
        return Image.network('images/hearts.png');
      case CardSuit.diamonds:
        return Image.network('images/diamonds.png');
      case CardSuit.clubs:
        return Image.network('images/clubs.png');
      case CardSuit.spades:
        return Image.network('images/spades.png');
      default:
        return null;
    }
  }
